...
costs_CH4_S = XLSX.readdata(data_file, "Données_gaz", "K14")
costs_CH4_import_year = XLSX.readdata(data_file, "Prix_gaz_import", "D5:D9510")
costs_CH4_N = XLSX.readdata(data_file, "Données_gaz", "K16:K17")

costs_CH4_import = costs_CH4_import_year[t_start:t_end]
...
#costs gaz
c_CH4_S = fill(Float64(costs_CH4_S), Tmax)
...
@objective(model, Min,
  ...
  + sum(P_CH4_S[t,1] * c_CH4_S[t] for t in 1:Tmax)
  + sum(P_CH4_S[t,2] * costs_CH4_import[t] for t in 1:Tmax)
